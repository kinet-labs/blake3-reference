# LICENSE-NOTICE — kinet-labs/blake3-reference
...
kinet-labs/crypto/blake3 ships a first-party BLAKE3 implementation in
`cpp/blake3.cpp`. The reference C tree from this fork is FetchContent'd by
kinet-labs/crypto and built as the `blake3_reference` OBJECT library, used as a
...
* New tags are cut only after BLAKE3 KATs in kinet-labs/crypto pass against the
  new tree.
